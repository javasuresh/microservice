...
public class UserResource extends ExceptionHandling {
    ...
    @PostMapping(value = "/change-passcode", produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<HttpResponse> changePassword(@RequestBody PasswordRequest request) throws MessagingException, EmailNotFoundException{
        System.out.println("=================request:"+request.getConformPassword());
